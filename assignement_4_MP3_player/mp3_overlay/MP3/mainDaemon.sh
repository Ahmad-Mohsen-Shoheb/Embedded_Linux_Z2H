...
# lsmod - Show the status of modules in the Linux Kernel, works with 'modprobe'
if [ $driverLoadedFlag -eq 0 ]; then
  modprobe snd-bcm2835
# snd_bcm2835 is the hardware abstraction layer for the audio I/O for the BCM2835 SOC.
